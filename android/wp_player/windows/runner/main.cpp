...
constexpr wchar_t WINDOW_NAME[]       = L"Wavepaths";
constexpr wchar_t kFlutterAssetPath[] = L"data";
...
wWinMain (_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev, _In_ wchar_t* command_line, _In_ int show_command) {
    if (SendAppLinkToInstance(WINDOW_NAME)) {
        return EXIT_SUCCESS;
    }
    ...
    flutter::DartProject project(kFlutterAssetPath);
